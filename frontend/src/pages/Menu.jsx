...
export default function Menu() {
    ...
    async function obtenerCategorias() {
        try {
            const response = await fetch("http://jardinbarra32.utportfolio.cloud/api/categorias/jardin");
    ...
    async function obtenerMenu() {
        try {
            const response = await fetch("http://jardinbarra32.utportfolio.cloud/api/menu/jardin");
            const data = await response.json();
            setFoods(data);
        } catch (error) {
            console.error(error);
    ...
    async function obtenerPorCategoria(id) {
        try {
            ...
            const response = await fetch(
                `http://jardinbarra32.utportfolio.cloud/api/categorias/jardin/${id}`
            );
