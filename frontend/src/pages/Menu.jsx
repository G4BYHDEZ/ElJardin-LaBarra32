...
export default function Menu() {
    ...
    async function obtenerCategorias() {
        try {
            const response = await fetch("http://localhost:5111/api/categorias");
    ...
    async function obtenerMenu() {
        try {
            const response = await fetch("http://localhost:5111/api/menu");
            const data = await response.json();
            setFoods(data);
        } catch (error) {
            console.error(error);
    ...
    async function obtenerPorCategoria(id) {
        try {
            ...
            const response = await fetch(
                `http://localhost:5111/api/categorias/${id}`
            );
